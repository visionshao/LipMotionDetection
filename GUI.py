...
label_input_notice = tk.Label(window, font=('Arial', 14), text='  (NOTICE that SAN now only supports picture input.)')
label_input_notice.place(x=10, y=125)
# radiobutton_input
input_type.set('picture')
r_btn_input_1 = tk.Radiobutton(window, font=('Arial', 14), text='Picture', variable=input_type, value='picture')
